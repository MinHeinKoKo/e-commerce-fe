        ...
        <div className="bg-gray-100 p-8">
          <div className="max-w-7xl mx-auto flex items-center justify-center gap-20">
            ...
            <div className="flex-1 mr-8">
              ...
              <Link className="cursor-pointer border rounded-full border-blue-400 text-blue-500 px-6 py-2 my-3 transition font-semibold hover:bg-blue-400 hover:text-white " to="shops" >Shop Now</Link>
            </div>
            {/* Your image */}
